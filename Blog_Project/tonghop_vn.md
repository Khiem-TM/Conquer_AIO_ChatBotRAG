# Quy trình Xây dựng Chatbot RAG End-to-End 
...
## 1. Data Owner: Pipeline ingest dữ liệu

<p align="center"><img src="Generated_Image.png" width="760"></p>
<p align="center"><em>Hình 1: Tổng quan.</em></p>
...
Incremental sync cho phép  đáp ứng yêu cầu trong tài liệu:
...
Ngoài hai thao tác ở trên, phần 2 còn cần hỗ trợ:
...
- **Fallback sang hashed embedding** khi môi trường local chưa đủ:
  ...
  - Mục tiêu là:
    - Giữ cho **pipeline vẫn chạy được** trên mọi máy.
...
### 2.6. Payload index và điểm bàn giao cho Retrieval

Khi index đã được xây xong, cần đảm bảo:
...
## 3. Retrieval Owner: Thiết kế Hybrid Retrieval cho RAG Chatbot


### 3.1. Vai trò của retrieval trong project

<p align="center"><img src="imgpart3.png" width="760"></p>
<p align="center"><em>Hình 2. Retrival.</em></p>
...
### 3.4. Kết luận từ góc nhìn Retrieval Owner
...
## 4. RAG Core Owner: Ghép ngữ cảnh, thiết kế prompt và trả lời có citation
...
## 5. DevOps + Frontend: Bảo đảm hệ thống chạy được end-to-end




### 5.1. Bức tranh tổng thể: Backend + Frontend 
Bạn có thể hình dung hệ thống gồm 3 “nhân vật” chính:
...
Vì vậy, phần 5 tập trung vào 2 chữ **tự tin** của người dùng:
...
## 6. Hướng dẫn nhanh để chạy project 
